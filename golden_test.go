...
func runGoldenTest(t *testing.T, test Golden, 
	   generateJSON, generateYAML, generateSQL, generateText, generateBSON, linecomment, generateGQLGen, generateValuesMethod bool,
	...
	g.generate(tokens[1], generateJSON, generateYAML, generateSQL, generateText, generateBSON, generateGQLGen, "noop", trimPrefix, prefix, linecomment, generateValuesMethod)
	got := string(g.format())
